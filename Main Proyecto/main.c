...
int main(){
  ...
  int E1,E2,ND,Contador,rep,V1;
  char nombre[30],nombre1[30],nombre2[30],nombre3[30],nombre4[30],RD,Opcion[100],respuesta1[]="Menu de opciones",respuesta2[]="Guardar nueva funcion",respuesta3[]="Calcular imagen",respuesta4[]="Manual",respuesta5[]="Volver",respuesta6[]="Salir",Nueva[50];
